    ...
    <BottomSheet open={true} onClose={handleClose}>
      <div className="p-8 flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <p className="text-text text-sm font-medium mb-1">{t('auth.welcomeShort')}</p>
          <p className="text-dim text-xs">{t('auth.signInPrompt')}</p>
          ...
          <div className="flex flex-col items-center gap-3 w-full">
            {loading ? (
              ...
              >
                ...
                <span>{nativeReady ? t('auth.signInWithGoogle') : t('common.loading')}</span>
              </button>
            ) : (
              <>
                <div ref={btnRef} />
